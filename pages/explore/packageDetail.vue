<template>
    <view class="container">
        ...
        <view class="packageDetail">
            <view class="packageDetail_top">
                ...
                <view class="banner-box">
                    <swiper class="swiper" :autoplay="true" :interval="3000" :duration="500" indicator-dots
                        :circular="true" indicator-active-color="#007aff">
                        <swiper-item class="swiper-item" v-for="(item, index) in buyItem?.comboPhotoUrl?.split(',')" :key="index">
                            <image :src="item" mode="aspectFill"></image>
                            <view class="swiper-item-title">限时{{buyItem?.discount}}折</view>
                        </swiper-item>
                    </swiper>
                </view>
            ...
            <view class="packageDetail_bottom">
                ...
                <view class="bottom_content">
                    <view class="bottom_content_item" v-for="(item, index) in buyItem?.comboClassifyList" :key="index">
                        <view class="bottom_content_item_title">
                            <view class="dian">·</view> {{item.name}}
                        </view>
                        <view class="bottom_content_item_content" v-for="(item2, index2) in item?.shopComboClassifyList" :key="index2">
                ...
                <view class="no_text no_padd">· 消费高峰期到店，可能需要等位，敬请期待</view>
                <view class="no_text no_padd">· 本单发票由商家提供，具体请咨询商家</view>
                <view class="icon_text">
                ...
                <view class="popup_content_item">
                    <view class="item_left">
                        <image :src="info?.profilePhotoUrl?.split('?')[0] || ''" mode="aspectFill"></image>
                    </view>
                    <view class="item_right">
                        <view class="right_text">{{ info?.name }}</view>
                        <view class="right_address">{{ info?.distanceMeters }} | {{ info?.address }}</view>
                    </view>
                </view>
            </view>
        </view>
        ...
        <PoupWrap :show="applyPopup" @close="applyPopup = false" :rightText="''" title="确认订单" @save="doApplyPopup">
            <view class="popup_content">
                <view class="popup_content_item">
                    <view class="item_left">
                        <image :src="buyItem?.comboPhotoUrl?.split('?')[0] || ''" mode="aspectFill"></image>
                    </view>
                ...
                <view class="popup_number">
                    ...
                    <view class="number_right">
                        <view class="right_btn" :class="{ active: buyNumber === 1 }" @click="changeNumber(1)">-</view>
                ...
                <view class="buy_btn">
                    <view class="buy_btn_left">
                        ...
                        <view class="right_text"><text>￥</text> {{ getMaxPrice(buyItem?.comboPrice) }}</view>
                    </view>
