	...
	<view class="page">
		<view class="card">
			...
			<view class="info">
				<view>退款说明</view>
				<view class="textarea">
					<textarea maxlength="50" v-model="reason" cols="30" rows="10"></textarea>
					<text  class="show">{{ reason.length }}/{{ max }}</text>
				</view>
			</view>
		</view>
		<PoupWrap :show='show' @close='show = false' title='选择退款理由'  :rightText="''">
			<Reason :list='reasonList' :index='selectIndex' @checked='doReason'></Reason>
		</PoupWrap>
